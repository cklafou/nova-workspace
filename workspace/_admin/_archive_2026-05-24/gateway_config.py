# Last updated: 2026-05-28 07:41:31
...
# This file lives at: workspace/general_tools/gateway_config.py
...
DEFAULT_CONFIG: dict[str, Any] = {
    # Inference settings (llama.cpp standalone server)
    "inference": {
...
class GatewayConfig:
    ...
    Access sections as attributes: cfg.inference, cfg.discord, etc.
    Access individual keys: cfg.get("inference.max_tokens")
    """
    ...
    def get(self, dot_path: str, default=None):
        """cfg.get("inference.max_tokens") → 16384 """
    ...
    def __repr__(self) -> str:
        return f"<GatewayConfig workspace={WORKSPACE} inference=nova-llamacpp>"
...
# Usage: from gateway_config import cfg
...
if __name__ == "__main__":
    ...
    print(f"Inference: llama.cpp @ localhost:8080/v1/chat/completions  ctx={cfg.inference['context_window']}")
