...
_Source of truth: workspace/NCL_MASTER.md | Parser: general_tools/nova_chat/nova_lang.py_
...
`general_tools/nova_chat/nova_lang.py` — parse_ncl(), summarize_ncl(), ncl_to_dict()
`general_tools/nova_chat/orchestrator.py` — MODULE_REGISTRY, get_module(), list_modules()
