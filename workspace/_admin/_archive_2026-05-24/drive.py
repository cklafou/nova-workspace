...
FILE_DESCRIPTIONS = {
    ...
    "BOOTSTRAP.md":    "Boot sequence Nova follows on every session start",
    "NOVA.md":         "Nova's identity, soul, personality, and values — single source of truth",
...
def _build_gemini_index_content() -> str:
    ...
    lines.append("Step 2: @Google Drive: Search for 'workspace/general_general_tools/nova_sync/GEMINI_INDEX.md'")
