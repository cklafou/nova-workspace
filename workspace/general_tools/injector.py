# Last updated: 2026-06-27 03:47:54
...
class NCLInjector:
    ...
    async def _module_eyes(
        ...
        Calls NovaEyes from nova_senses.eyes with the [[instructions]] as
        ...
        try:
            import sys as _sys
            for _p in [str(self.workspace / "nova_body"), str(self.workspace / "general_tools")]:
