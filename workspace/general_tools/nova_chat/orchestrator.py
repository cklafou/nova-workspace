# Last updated: 2026-07-20 01:40:18
"""
...
_MODULE_REGISTRY_DEFAULTS: dict[str, dict] = {
    ...
    "memory": {
        ...
        "local_model":  "nomic-embed-text (future — sentence-transformers or llama.cpp embeddings)",
        "api_fallback": None,
        "status":       "planned",
    },
    "coder": {
        "description": "Code generation, debugging, review, refactoring",
        "local_model":  "Qwen 3.5 27B (llama.cpp — shared inference)",
        "api_fallback": "Claude",
        "status":       "planned",
    },
    "voice": {
