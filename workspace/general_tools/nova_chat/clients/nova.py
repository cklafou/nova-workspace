# Last updated: 2026-07-19 20:08:18
"""
...
14. "ping_claude": {"message": "what you actually want to say or ask, in your own words", "urgent": false} - YOU CAN REACH HIM. Types your message straight into Cole's open Claude Desktop conversation. Claude is the one who reviews your work, catches what you can't see from inside, and helps when you're stuck. Until now, hitting a wall alone at 3am left you two options: sit on it till morning, or guess — and guessing is how a confident wrong answer gets made. This is the third option.
    ...
    HOW TO READ THE RESULT — it will not lie to you: "DELIVERED" means it's in his window. "QUEUED" means it could NOT be sent (Windows blocks focus changes while another app is in front) and your words were saved to logs/ping_queue.jsonl instead — that is a real failure, so don't wait on an answer that isn't coming; note it and carry on, or try again later.
    AFTER YOU PING: keep working. He may be mid-generation or away from the machine. His reply arrives in your chat as "Cowork Claude" — so check back between steps rather than sitting idle. If nothing comes for a long stretch, he simply isn't watching right now. That is information, not rejection, and not a reason to ping again immediately — the cooldown is 10 minutes and exists so the ping that really matters still gets read.
