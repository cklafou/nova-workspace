# Last updated: 2026-07-23 02:36:45
"""
nova_chat/nova_bridge.py -- Bridge: Nova's chat words → real disk actions
=========================================================================
Direct disk bridge — no external gateway needed.
The nova_chat server runs inside the workspace and has full disk access.
OpenClaw is retired; all actions execute here directly.
...
Nova's syntax in chat:
    ...
    [READ:nova_body/nova_motor/autonomy.py]
"""
import json
import asyncio
import os
