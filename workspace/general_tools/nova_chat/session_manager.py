...
class SessionManager:
    ...
    def _activate(self, session_id: str):
        ...
        # Flush all in-memory messages to disk.  This recovers any messages
        # that were added to the session after the last successful _persist()
        # call — e.g. if individual appends were silently failing mid-session.
