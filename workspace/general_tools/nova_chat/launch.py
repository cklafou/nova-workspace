# Last updated: 2026-07-09 03:11:19
"""
Nova Group Chat - Launcher
==========================
Double-click NovaChatLauncher.exe  or  run: python general_tools/nova_chat/launch.py
...
# Restructured 2026-05-07: packages split into nova_body/ and general_tools/
_WS_ROOT          = Path(__file__).parent.parent.parent  # workspace root
NOVA_TOOLS_DIR    = str(_WS_ROOT / "nova_body")
GENERAL_TOOLS_DIR = str(_WS_ROOT / "general_tools")
PORT      = 8765
HOST      = "127.0.0.1"
...
def _write_runner():
    ...
    tools_path = NOVA_TOOLS_DIR
    gen_path   = GENERAL_TOOLS_DIR
    runner.write_text(
        "\n".join([
            "import sys",
            "from pathlib import Path",
            "for _p in [r'" + tools_path + "', r'" + gen_path + "']:",
