...
Three real events had been written six times between 05-28 and 06-03 — the grovel-loop era,
before the pacing and echo fixes landed. The lesson is preserved; only the repetition moved._
...
## Also removed: 8 machine log lines

These were `[autonomy/self-check] reconciled queue from TASK_INTENT` lines written into the
journal by the autonomy loop. They are not journal entries, they were filed under a
`2026-03-28` heading while carrying 05-23/05-24 timestamps, and nothing about them is hers.
