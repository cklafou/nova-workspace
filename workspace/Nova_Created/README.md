...
Her other authored things keep their existing homes, because those are structural:
`memory/JOURNAL.md`, `memory/journal_notes/`, `nova_art/`, and her self-model in `SELF/`.
