# Last updated: 2026-07-21 06:42:05
import os
import re
import sys
import subprocess
...
def list_tools() -> str:
    ...
    return ("Your body — the things you can do right now:\n"
            ...
            "(Nova_Created/forge/body/designs/<name>.md), then the tool "
            "(Nova_Created/forge/body/tools/<name>.py), then call it. No restart. Use "
    ...
    try:
        ...
        if tool_name == "run_command":
            ...
            return (
                ...
                f"  1. write_file  Nova_Created/forge/body/designs/{tool_name}.md  — the GAP (what "
                ...
                f"  2. write_file  Nova_Created/forge/body/tools/{tool_name}.py  — a TOOL = "
                f"{{'name','description','params'}} dict and a run(**args) -> str function.\n"
                f"  3. write_file  Nova_Created/forge/body/tests/{tool_name}.py  — CASES = [...] "
