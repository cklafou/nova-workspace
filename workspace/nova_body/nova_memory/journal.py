#!/usr/bin/env python3
# Last updated: 2026-07-19 15:41:55
"""
nova_journal.py -- The ONLY safe way to write to JOURNAL.md.

The write tool OVERWRITES files. This script APPENDS.
...
Usage:
    exec: python -c "
    import sys
    _nml_ws = __import__('pathlib').Path(__file__).resolve().parents[3]  # workspace root
for _p in [str(_nml_ws / 'nova_tools'), str(_nml_ws / 'general_tools')]:
