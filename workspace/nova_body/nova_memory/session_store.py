...
File location: workspace/logs/gateway_sessions/YYYY-MM-DD/<uuid>.jsonl
...
class Session:
    ...
    def build_messages(self) -> list[dict]:
        """
        Convert session records into the OpenAI-compatible message list format nova_chat expects.
    ...
    def needs_compaction(self) -> bool:
        ...
        ctx  = cfg.inference["context_window"]
