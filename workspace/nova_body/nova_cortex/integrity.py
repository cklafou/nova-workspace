# Last updated: 2026-07-21 20:05:22
...
# ── MOVED to nova_cortex/witness.py (2026-07-21, the consolidation) ────────────────────
# The sensory regex + claims_a_perception, _ATTRIBUTION_RE / claims_an_attribution,
# _PRESENCE_RE / claims_a_presence, needs_self_check (now witness.needs_witness), the wire
# record (_recent_spoken -> witness.wire_record) and the audit (build_self_check ->
# witness.build_witness, parse_self_check -> witness.parse_witness). One organ, one file:
# the witness owns every claim about the ROOM — who is present, who spoke, what she
# perceives. Integrity keeps the claims about her HANDS: reach, receipts, the challenge.
