#!/usr/bin/env python3
# Last updated: 2026-06-22 18:56:07
"""
...
The scheduler (nova_cortex/circadian.py) calls into this module to build the
...
Designed to be imported by:
  nova_cortex/circadian.py   — calls build_briefing() for the cron heartbeat
  nova_cortex/agent_loop.py  — queries orient() to build context blocks
  future: injector.py — checks get_active_thoughts() before dispatching
"""
...
# Workspace root — 2 levels up: nova_cortex/ → tools/ → workspace/
