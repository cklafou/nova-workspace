...
Usage (from Nova's exec or agent code):
    exec: python -c "
    import sys
    _ns_ws = __import__('pathlib').Path(__file__).resolve().parents[3]  # workspace root
for _p in [str(_ns_ws / 'nova_tools'), str(_ns_ws / 'general_tools')]:
...
if __name__ == "__main__":
    ...
    # Usage: python nova_tools/nova_cortex/nova_status.py "pulse text" "summary text"
